...
extern "C" DLLEXP t_eclipse_data ec_;
extern "C" DLLEXP t_ext_type ec_xt_double_arr;
extern "C" DLLEXP t_ext_type ec_xt_long_arr;
extern "C" DLLEXP t_ext_type ec_xt_char_arr;
extern "C" DLLEXP int Winapi ec_set_option_int (int, int);
extern "C" DLLEXP int Winapi ec_set_option_long (int, word);
extern "C" DLLEXP int Winapi ec_set_option_ptr (int, void *);
extern "C" DLLEXP int Winapi ec_init (void);
extern "C" DLLEXP int Winapi ec_cleanup (void);
extern "C" DLLEXP void Winapi ec_post_goal (const pword);
extern "C" DLLEXP void Winapi ec_post_string (const char *);
extern "C" DLLEXP void Winapi ec_post_exdr (int, const char *);
extern "C" DLLEXP int Winapi ec_resume (void);
extern "C" DLLEXP int Winapi ec_resume1 (ec_ref);
extern "C" DLLEXP int Winapi ec_resume2 (const pword,ec_ref);
extern "C" DLLEXP int Winapi ec_resume_long (long *);
extern "C" DLLEXP int Winapi ec_resume_async (void);
extern "C" DLLEXP int Winapi ec_running (void);
extern "C" DLLEXP int Winapi ec_resume_status (void);
extern "C" DLLEXP int Winapi ec_resume_status_long (long *);
extern "C" DLLEXP int Winapi ec_wait_resume_status_long (long *, int);
extern "C" DLLEXP int Winapi ec_post_event (pword);
extern "C" DLLEXP int Winapi ec_post_event_string (const char *);
extern "C" DLLEXP int Winapi ec_post_event_int (int);
extern "C" DLLEXP int Winapi ec_handle_events (long *);
extern "C" DLLEXP void Winapi ec_cut_to_chp (ec_ref);
extern "C" DLLEXP pword Winapi ec_string (const char*);
extern "C" DLLEXP pword Winapi ec_length_string (int, const char*);
extern "C" DLLEXP pword Winapi ec_atom (const dident);
extern "C" DLLEXP pword Winapi ec_long (const long);
extern "C" DLLEXP pword Winapi ec_long_long (const long long);
extern "C" DLLEXP pword Winapi ec_double (const double);
extern "C" DLLEXP pword ec_term (dident, ... );
extern "C" DLLEXP pword Winapi ec_term_array (const dident,const pword[]);
extern "C" DLLEXP pword Winapi ec_list (const pword,const pword);
extern "C" DLLEXP pword Winapi ec_listofrefs (ec_refs);
extern "C" DLLEXP pword Winapi ec_listofdouble (int, const double*);
extern "C" DLLEXP pword Winapi ec_listoflong (int, const long*);
extern "C" DLLEXP pword Winapi ec_listofchar (int, const char*);
extern "C" DLLEXP pword Winapi ec_arrayofdouble (int, const double*);
extern "C" DLLEXP pword Winapi ec_matrixofdouble (int, int, const double*);
extern "C" DLLEXP pword Winapi ec_handle (const t_ext_type*,const t_ext_ptr);
extern "C" DLLEXP pword Winapi ec_newvar (void);
extern "C" DLLEXP pword Winapi ec_nil (void);
extern "C" DLLEXP dident Winapi ec_did (const char *,const int);
extern "C" DLLEXP int Winapi ec_get_string (const pword,char**);
extern "C" DLLEXP int Winapi ec_get_string_length (const pword,char**,long*);
extern "C" DLLEXP int Winapi ec_get_atom (const pword,dident*);
extern "C" DLLEXP int Winapi ec_get_long (const pword,long*);
extern "C" DLLEXP int Winapi ec_get_long_long (const pword,long long*);
extern "C" DLLEXP int Winapi ec_get_double (const pword,double*);
extern "C" DLLEXP int Winapi ec_get_nil (const pword);
extern "C" DLLEXP int Winapi ec_get_list (const pword,pword*,pword*);
extern "C" DLLEXP int Winapi ec_get_functor (const pword,dident*);
extern "C" DLLEXP int Winapi ec_arity (const pword);
extern "C" DLLEXP int Winapi ec_get_arg (const int,pword,pword*);
extern "C" DLLEXP int Winapi ec_get_handle (const pword,const t_ext_type*,t_ext_ptr*);
extern "C" DLLEXP int Winapi ec_is_var (const pword);
extern "C" DLLEXP ec_refs Winapi ec_refs_create (int,const pword);
extern "C" DLLEXP ec_refs Winapi ec_refs_create_newvars (int);
extern "C" DLLEXP void Winapi ec_refs_destroy (ec_refs);
extern "C" DLLEXP void Winapi ec_refs_set (ec_refs,int,const pword);
extern "C" DLLEXP pword Winapi ec_refs_get (const ec_refs,int);
extern "C" DLLEXP int Winapi ec_refs_size (const ec_refs);
extern "C" DLLEXP ec_ref Winapi ec_ref_create (pword);
extern "C" DLLEXP ec_ref Winapi ec_ref_create_newvar (void);
extern "C" DLLEXP void Winapi ec_ref_destroy (ec_ref);
extern "C" DLLEXP void Winapi ec_ref_set (ec_ref,const pword);
extern "C" DLLEXP pword Winapi ec_ref_get (const ec_ref);
extern "C" DLLEXP int Winapi ec_exec_string (char*,ec_ref);
extern "C" DLLEXP int Winapi ec_var_lookup (ec_ref,char*,pword*);
extern "C" DLLEXP pword Winapi ec_arg (int);
extern "C" DLLEXP int Winapi ec_unify (pword,pword);
extern "C" DLLEXP int Winapi ec_unify_arg (int,pword);
extern "C" DLLEXP int Winapi ec_compare (pword,pword);
extern "C" DLLEXP int Winapi ec_visible_procedure (dident,pword,void**);
extern "C" DLLEXP int Winapi ec_make_suspension (pword,int,void*,pword*);
extern "C" DLLEXP int Winapi ec_schedule_suspensions (pword,int);
extern "C" DLLEXP int Winapi ec_free_handle (const pword, const t_ext_type*);
extern "C" DLLEXP int ec_external (dident,int (*) (...),dident);
extern "C" DLLEXP int Winapi ec_get_stream (const pword,stream_id*);
extern "C" DLLEXP int Winapi ec_stream_nr (const char *name);
extern "C" DLLEXP int Winapi ec_queue_write (int stream, char *data, int size);
extern "C" DLLEXP int Winapi ec_queue_read (int stream, char *data, int size);
extern "C" DLLEXP int Winapi ec_queue_avail (int stream);
extern "C" DLLEXP void Winapi ec_double_xdr (double * d, char * dest);
extern "C" DLLEXP void Winapi ec_int32_xdr (int32 * l, char * dest);
extern "C" DLLEXP void Winapi ec_xdr_int32 (char * buf , int32 * l);
extern "C" DLLEXP void Winapi ec_xdr_double (char * buf , double * d);
extern "C" DLLEXP char * Winapi ec_error_string (int);
extern "C" DLLEXP void ec_panic (const char* what, const char* where);
enum EC_status
{
 EC_succeed = 0,
 EC_fail = 1,
